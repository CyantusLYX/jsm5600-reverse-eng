...
| `[C3 00 00 00 02 00]` | **GetLegacyStatus (Short)** | 讀取短狀態塊 (輪詢) |
| `[C3 00 00 00 04 00]` | **GetLegacyStatus (Long)** | 讀取長狀態塊 (輪詢) |
...
- **FIS 數據** (Data): `[DE 02 00 00 18 00]`
- **FIS 擴展狀態** (Ext Status): `[DE 03 00 00 18 00]`
- **FIS 保留 4**: `[DE 04 00 00 18 00]`
- **FIS 保留 5**: `[DE 05 00 00 18 00]`
- **FIS 保留 6**: `[DE 06 00 00 18 00]`
- **FIS 保留 7**: `[DE 07 00 00 18 00]`
- **FIS 保留 8**: `[DE 08 00 00 18 00]`
- **FIS 保留 9**: `[DE 09 00 00 18 00]`
- **ROM 版本**:
